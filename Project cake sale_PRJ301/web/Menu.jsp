...
<nav class="navbar navbar-expand-md navbar-dark bg-dark">
    <div class="container">
        <a class="navbar-brand" href="home">NamHoang Cake</a>
...
<section class="jumbotron text-center">
    <div class="container">
        <h1 class="jumbotron-heading">Thay lời yêu thương</h1>
        <p class="lead text-muted mb-0">Chào mừng quý khách đến với NamHoangCake</p>
    </div>
</section>
<!--end of menu-->
